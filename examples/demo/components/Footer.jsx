        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-10">
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-slate-600">
              ...
              <li><a href="#docs" className="transition hover:text-slate-900">Documentation</a></li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-slate-600">
              <li><a href="https://github.com/bhavik-dreamz/react-page-builder-free" target="_blank" rel="noreferrer" className="transition hover:text-slate-900">GitHub</a></li>
